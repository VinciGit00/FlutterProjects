...
class GraficoCircolare3 extends StatefulWidget {
  GraficoCircolare3({Key? key}) : super(key: key);

  @override
  State<GraficoCircolare3> createState() => _GraficoCircolare3State();
}

class _GraficoCircolare3State extends State<GraficoCircolare3> {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: SfCircularChart(
          title: ChartTitle(text: "Grafico radiale"),
